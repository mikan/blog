...
今回、前述のトイレ検索アプリの API を東京メトロから協議会へ切り替える作業を行なったので、API ユーザーとしての具体的な注意点・作業内容と、また API 設計の考察をごく簡単にまとめたいと思います。
...
たくさんの種類のオープンデータに手を出した人ほど今回の影響を受けてしまうので、今までの意欲的なデータ提供に感謝すつつ、もう少し救済措置が欲しかったかなとは思います。
